...
![A conference panel in front of a screen with a map and a statement.](/blog/beyond-rooms-hero.webp)
_Created with OpenAI Sora._
...
1. **Livestreams** let remote audiences watch in real time, bridging the spatial gap.

2. **Recordings** let people catch up later, bridging both spatial and temporal gaps.

3. **Q&A sessions** allow for some back-and-forth -- often constrained, often privileging those in the room.
...
![Triangular voting interface](/blog/beyond-rooms-triangular-interface.png)
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
  <img src="/blog/beyond-rooms-perspective-map-1.png" alt="Perspective map example 1" />
  <img src="/blog/beyond-rooms-perspective-map-2.webp" alt="Perspective map example 2" />
</div>
